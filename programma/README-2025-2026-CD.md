...
| Dag | Project & Kennissessie |
| --- |  --- |
| ma  | ${\color{blue}\mathrm{ESP}}$ [Traffic light](../programma/lesprogramma/programma-std-code-intro.md) (**BB**) |
...
| do  | ${\color{green}\mathrm{Project}}$ Show & tell + Verantwoordingsdocument check (**TM & BB & MV**) |
