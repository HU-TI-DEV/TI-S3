...
| --- |  --- |
| ma  | [Kickoff](./lesprogramma/programma-kickoff.md) programma <br> Getting to know each other (**TM & LB**) <br>[Journalling](../organisatorisch/journaliseren.md) (**MV**)<br> ${\color{blue}\mathrm{ESP}}$ [installatie I](../infrastructuur/ESP32-IDF-opzet/ESP32-IDF-opzet-Windows.md) (**BB**) |
...
| do  | ${\color{green}\mathrm{Project}}$ Show & tell + Verantwoordingsdocument check (**TM & BB**) |
...
| do  | ${\color{green}\mathrm{Project}}$ Show & tell + Verantwoordingsdocument check (**TM**) |
