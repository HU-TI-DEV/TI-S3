...
| --- |  --- |
| ma  | [Kickoff](./lesprogramma/programma-kickoff.md) programma <br> Getting to know each other (**BB & LB**) <br>[Journalling](../organisatorisch/journaliseren.md) (**HP**)<br> ${\color{blue}\mathrm{ESP}}$ [installatie I](../infrastructuur/ESP32-IDF-opzet/ESP32-IDF-opzet-Windows.md) (**BB**) |
| di  | ${\color{blue}\mathrm{ESP}}$  [installatie II](../infrastructuur/ESP32-IDF-opzet/ESP32-IDF-opzet-Windows-II.md) (**BB**) |
| wo  | ${\color{red}\mathrm{SW~Architecture}}$ [system context- key drivers, prioriteren](./lesprogramma/programma-systemcontext-keydrivers-applicationdrivers.md)  (**HP**)|
...
| Dag | Project & Kennissessie |
| --- |  --- |
| ma  | ${\color{blue}\mathrm{ESP}}$ [LEDs](./lesprogramma/programma-CYD-LED.md) + [PWM](./lesprogramma/programma-CYD-PWM-LEDS.md)  ${\color{blue}\mathrm{ESP}}$ [Game opdracht introductie](./lesprogramma/programma-game-introductie.md) (**BB**)|
...
| wo  | ${\color{blue}\mathrm{ESP}}$ [SPI/scherm](../programma/lesprogramma/programma-CYD-drawables.md) drawables (**BB, HP**) |
| do  | PROJECT TBD (**BB**)|
...
| Dag | Project & Kennissessie |
| --- |  --- |
| ma  | ${\color{blue}\mathrm{ESP}}$ [keypad](./lesprogramma/programma-CYD-keypad.md) en ADC (**HP**) |
...
| Dag | Project & Kennissessie |
| --- |  --- |
| ma  | ${\color{blue}\mathrm{ESP}}$ [SPI/scherm](../programma/lesprogramma/programma-CYD-backbuffer.md) backbuffer (**HP**)|
| di  | ${\color{red}\mathrm{SW~Architecture}}$  [Taakstructuring](./lesprogramma/programma-taakstructurering.md) (**MV**)|
| wo  | ${\color{blue}\mathrm{ESP}}$ [Sprites](./lesprogramma/programma-CYD-sprites.md) (**HP**)|
...
| Dag | Project & Kennissessie |
| --- |  --- |
| ma  | ${\color{blue}\mathrm{ESP}}$ [IO expander](./lesprogramma/programma-CYD-IO-expander.md) (**HP**) |
| di  | ${\color{red}\mathrm{SW~Architecture}}$  [STD](./lesprogramma//programma-std-2.md)   (**MV**) |
| wo  | ${\color{orange}\mathrm{C++}}$ [Inheritance/Compositie](../software/inheritance-composition/README.md) (**HP**) |
...
| Dag | Project & Kennissessie |
| --- |  --- |
| ma  | ${\color{blue}\mathrm{ESP}}$ [BLE](./lesprogramma/programma-CYD-BLE.md) BLE & networking basics  (**HS**) & [Testen](./lesprogramma/programma-testen.md) (**BB**)  |
| di  | Feedback mogelijkheid (**MV**, en **BB**) |
...
| Dag | Project & Kennissessie |
| --- |  --- |
| ma  | ${\color{blue}\mathrm{ESP}}$ [werken aan game](../software/) (**HP**) |
...
| Dag | Project & Kennissessie |
| --- |  --- |
| ma  | ${\color{blue}\mathrm{ESP}}$ [werken aan game](../software/) + feedback ophalen (**HP**) |
| di  | ${\color{green}\mathrm{Project}}$ Werken aan project (**BB**) |
| wo  | ${\color{green}\mathrm{Project}}$ Werken aan project (**HP**) |
...
| ma  | ${\color{blue}\mathrm{ESP}}$ [werken aan game](../software/) (**HP**) |
| di  | ${\color{green}\mathrm{Project}}$ Werken aan project (**BB**)|
| wo  | ${\color{blue}\mathrm{ESP}}$ [werken aan game](../software/) (**HP**) |
| do  | ${\color{green}\mathrm{Project}}$ Show & tell + Verantwoordingsdocument check (**BB**) |
...
| Dag | Project & Kennissessie |
| --- |  --- |
| ma  | ${\color{red}\mathrm{SW~Architecture}}$  Reviewen game <-> diagrammen, 20 min per student (**MV & BB**) |
| di  | ${\color{red}\mathrm{SW~Architecture}}$  Reviewen game <-> diagrammen, 20 min per student (**MV & BB**) |
| wo  | DEMO MARKT 13:00 aanvang , jullie gaan al je projecten demonstreren! & ${\color{red}\mathrm{SW~Architecture}}$  Reviewen game <-> diagrammen, 20 min per student (**MV&BB**) |
| do  | **4e Peilmoment** (**BB**)  |
