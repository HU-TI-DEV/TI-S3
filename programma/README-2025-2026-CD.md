...
| di  | ${\color{blue}\text{ESP}}$  [installatie II](../infrastructuur/ESP32-IDF-opzet/ESP32-IDF-opzet-Windows-II.md) (**BB**) |
| wo  | ${\color{red}\text{SW~Architecture}}$ [system context- key drivers, prioriteren](./lesprogramma/programma-systemcontext-keydrivers-applicationdrivers.md)  (**HP**)|
...
| di  | ${\color{red}\text{SW~Architecture}}$  [functionele en niet-functionele requirements](./lesprogramma/programma-requirements.md) (teamvorming) (**MV**) |
| wo  | ${\color{orange}\text{C++}}$ [Verdieping_OOP (presentaties)](lesprogramma/programma-verdieping-oop.md) (**HP**) |
| do  | ${\color{green}\text{Project}}$ Opdrachtgevers bezoek (**BB**) |
...
| Dag | Project & Kennissessie |
| --- |  --- |
| ma  | ${\color{blue}\text{ESP}}$ [keypad](./lesprogramma/programma-CYD-keypad.md) en ADC (**HP** ***CONFLICT_NEEDS_MOVE***) |
| di  | ${\color{red}\text{SW~Architecture}}$ [Objectmodel](./lesprogramma/programma-object-model-2.md)     (**MV**) |
| wo  | ${\color{blue}\text{ESP}}$ [Concurrency / synchronisatie](./files/Concurrency.pptx) (**BB**)  |
...
| wo  | ${\color{orange}\text{C++}}$ [Memory management](./lesprogramma/programma-memory-management.md) en Interrupts (**HP**) |
...
| do  | ${\color{green}\text{Project}}$ Show & tell (**BB**)+ [2e Peilmoment](../Verantwoordingsdocument_TI_S3.md) |
...
| do  | ${\color{green}\text{Project}}$ (**BB**) **Einde Sprint 3** |
