...
| --- |  --- |
| ma  |Kickoff - Getting to know each other (**TM & LB**) <br>${\color{red}\mathrm{Structuur}}$ [Journalling](../organisatorisch/journaliseren.md) (**MV**)<br> ${\color{blue}\mathrm{ESP}}$ [ installatie ESP](./lesprogramma/programma-kickoff.md) (**HS & BB**) |
