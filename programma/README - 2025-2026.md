...
| --- |  --- |
| ma  |[Kickoff](./lesprogramma/programma-kickoff.md) programma <br> Getting to know each other (**TM & LB**) <br>${\color{red}\mathrm{Structuur}}$ [Journalling](../organisatorisch/journaliseren.md) (**MV**)<br> ${\color{blue}\mathrm{ESP}}$ [ installatie I](../infrastructuur/ESP32-IDF-opzet/ESP32-IDF-opzet-Windows.md) (**HS & BB**) |
| di  |${\color{red}\mathrm{Structured~programming}}$ [system context- key drivers, prioriteren](./lesprogramma/programma-systemcontext-keydrivers-applicationdrivers.md)  (**MV**) |
...
| di  |${\color{red}\mathrm{Structured~programming}}$ [Use Case Diagram, Use Case Beschrijvingen](./lesprogramma/programma-use-case.md) + [Activity diagrammen](https://github.com/HU-TI-DEV/TI-S3/blob/main/programma/lesprogramma/programma-activity-diagrammen.md) (**MV**)  |
...
| Dag | Project & Kennissessie |
| --- |  --- |
| ma  |  ${\color{blue}\mathrm{ESP}}$ [keypad](../software/) (**HS & BB**) |
...
| di  | ${\color{red}\mathrm{Structured~programming}}$    [STD](./lesprogramma//programma-std-1.md) (**MV**) |
...
| Dag | Project & Kennissessie |
| --- |  --- |
| ma  |  ${\color{blue}\mathrm{ESP}}$ [WIFI & BLUETOOTH](../software/) (**HS & BB**)  |
