...
| wo  | ${\color{red}\mathrm{Structured~programming}}$ [Objectmodel](./lesprogramma/programma-object-model-1.md) + BUILDCHAIN    (**MV**) |
...
| wo  | ${\color{red}\mathrm{Structured~programming}}$    [Listener patterns]() (**MV**) |
| do  |${\color{green}\mathrm{Project}}$ Show & tell + Verantwoordingsdocument check (**TM & BB & HS & MV**) |
