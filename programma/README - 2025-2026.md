...
| --- | --- | --- |
| ma  | | Kickoff - <span style="color:blue">ESP</span> $${\color{red}Red}$$ [ installatie & Journalling](./lesprogramma/programma-kickoff.md) (**HS & BB**) |
| di  | | <span style="color:blue">ESP</span>  [installatie II](../infrastructuur/ESP32-IDF-opzet/ESP32-IDF-opzet-Windows-II.md) (**HS & BB**) |
| wo  | |<span style="color:yellow">Structured programming</span>  [system context- key drivers, prioriteren](./lesprogramma/programma-systemcontext-keydrivers-applicationdrivers.md)  (**MV**) |
| do  | |<span style="color:orange">C++</span>[ herhaling OO]()  (**GP**) |

### Onderwijsweek C3 (17-02-2025)

| Dag | Project | Kennissessie |
| --- | --- | --- |
| ma  | | <span style="color:blue">ESP</span> [LEDs](../software/) (**HS & BB**) |
| di  | | <span style="color:orange">C++</span> [herhaling OO]() (**GP**) |
| wo  | |<span style="color:yellow">Structured programming</span> [Functionele en niet-functionele requirements](./lesprogramma/programma-requirements.md)  (**MV**) |
| do  |<span style="color:lightgreen">Project</span> Opdrachtgevers bezoek (**TM**) ||
