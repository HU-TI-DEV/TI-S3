...
- [Programma](#programma)
  - [Onderwijsweek C2 (XX-XX-2025)](#onderwijsweek-c2-xx-xx-2025)
  - [Onderwijsweek C3 (XX-XX-2025)](#onderwijsweek-c3-xx-xx-2025)
  - [Onderwijsweek C4 (XX-XX-2025)](#onderwijsweek-c4-xx-xx-2025)
...
### Onderwijsweek C2 (XX-XX-2025)

| Dag | Project & Kennissessie |
| --- |  --- |
| ma  |  Kickoff - ${\color{blue}\mathrm{ESP}}$ [ installatie & Journalling](./lesprogramma/programma-kickoff.md) (**HS & BB**) |
| di  |  ${\color{blue}ESP}$  [installatie II](../infrastructuur/ESP32-IDF-opzet/ESP32-IDF-opzet-Windows-II.md) (**HS & BB**) |
| wo  | ${\color{red}Structured~programming}$ [system context- key drivers, prioriteren](./lesprogramma/programma-systemcontext-keydrivers-applicationdrivers.md)  (**MV**) |
| do  | ${\color{orange}C++}$  [ herhaling OO]()  (**GP**) |

### Onderwijsweek C3 (XX-XX-2025)

| Dag | Project & Kennissessie |
| --- |  --- |
| ma  |  ${\color{blue}ESP}$ [LEDs](../software/) (**HS & BB**) |
| di  |  ${\color{orange}C++}$ [herhaling OO]() (**GP**) |
| wo  | ${\color{red}Structured~programming}$  [Functionele en niet-functionele requirements](./lesprogramma/programma-requirements.md)  (**MV**) |
| do  |${\color{lightgreen}Project}$ Opdrachtgevers bezoek (**TM**) |

### Onderwijsweek C4 (XX-XX-2025)
