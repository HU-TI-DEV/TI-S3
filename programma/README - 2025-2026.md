...
| di  |${\color{orange}\mathrm{C++}}$  [ herhaling OO]()  (**HP**)|
...
| di  | ${\color{blue}\mathrm{ESP}}$ Korte introductie kwaliteitscriteria Game (**HS**)<br>14:00 -> ${\color{red}\mathrm{Structured~programming}}$ [Use Case Diagram, Use Case Beschrijvingen](./lesprogramma/programma-use-case.md) + [Activity diagrammen](https://github.com/HU-TI-DEV/TI-S3/blob/main/programma/lesprogramma/programma-activity-diagrammen.md) (**MV**) |
...
| wo  |  ${\color{blue}\mathrm{ESP}}$ [Beep & Sound](../software/) (**HS & BB**)|
...
| di  | ${\color{red}\mathrm{Structured~programming}}$ [Klassendiagram](./lesprogramma/programma-klassediagram-intro.md)   (**MV**) |
...
| wo  | ${\color{red}\mathrm{Structured~programming}}$    [STD](./lesprogramma//programma-std-1.md) (**MV**)|
| do  |${\color{green}\mathrm{Project}}$ NOG IETS KIEZEN (**TM**) |
