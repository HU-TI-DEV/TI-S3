...
- [Programma](#programma)
  - [Onderwijsweek C1 (XX-XX-2025)](#onderwijsweek-c1-xx-xx-2025)
  ...
  - [Onderwijsweek C5 (XX-XX-2025)](#onderwijsweek-c5-xx-xx-2025)
...
| Dag | Project & Kennissessie |
| --- |  --- |
| ma  |${\color{blue}\mathrm{ESP}}$ [LEDs](../software/) (**HS & BB**) |
| di  |${\color{orange}\mathrm{C++}}$ [herhaling OO]() (**GP**) |
| wo  |${\color{red}\mathrm{Structured~programming}}$  [Functionele en niet-functionele requirements](./lesprogramma/programma-requirements.md)  (**MV**) |
| do  |${\color{green}\mathrm{Project}}$ Opdrachtgevers bezoek (**TM**) |

### Onderwijsweek C3 (XX-XX-2025)
| Dag | Project & Kennissessie |
| --- |  --- |
| ma  |${\color{blue}\mathrm{ESP}}$ [LDR](../software/) (**HS & BB**) |
