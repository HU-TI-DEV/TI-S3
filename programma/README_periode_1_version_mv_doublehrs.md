...
| Dag | klas A | klas B|
| --- |  --- | --- |
| ma  | **Einde sprint 2** sprint demo (**GP**) | ${\color{red}\text{SW~Architecture}}$  [Taakstructuring](./lesprogramma/programma-taakstructurering.md) (**MV**)|
