...
| --- |  --- |
| ma  | [Kickoff en Kennismaking](./lesprogramma/programma-kickoff.md)  (**HS**) <br> [Journalling](../organisatorisch/journaliseren.md) (**HP**)<br> ${\color{blue}\text{ESP}}$ [installatie I](../infrastructuur/ESP32-IDF-opzet/ESP32-IDF-opzet-Windows.md) (**BB**) |
| di  |[Operating systems, State-Transition-Diagrams en Code](./lesprogramma/programma-OS-STD-Code.md) <br>  ${\color{blue}\text{ESP}}$  [installatie II](../infrastructuur/ESP32-IDF-opzet/ESP32-IDF-opzet-Windows-II.md) (**BB**) |
| wo  | Intro keydrivers/functional requirements (**TM**) <br> ${\color{green}\text{Project}}$ Opdrachtgever bezoek (**HS & TM**) |
| do  | ${\color{red}\text{SW~Architecture}}$ [system context- key drivers, prioriteren](./lesprogramma/programma-systemcontext-keydrivers-applicationdrivers.md)  (**TM**) |
...
| Dag | Project & Kennissessie |
| --- |  --- |
| ma  | teamvorming en **Start sprint 1** (**TM**) <br>${\color{blue}\text{ESP}}$ [Game opdracht introductie](./lesprogramma/programma-game-introductie.md) (**HS**)<br> [Operating systems, State-Transition-Diagrams en Code](./lesprogramma/programma-OS-STD-Code.md) <br>${\color{blue}\text{ESP}}$ [LEDs](./lesprogramma/programma-CYD-LED.md) + [PWM](./lesprogramma/programma-CYD-PWM-LEDS.md)  (**BB**) |
...
| Dag | Project & Kennissessie |
| --- |  --- |
| ma  | [Operating systems, State-Transition-Diagrams en Code](./lesprogramma/programma-OS-STD-Code.md) <br>${\color{blue}\text{ESP}}$ [ADC & LDR](./lesprogramma/programma-CYD-LDR.md)  (**BB**) <br> POP (**LB**)|
...
| do  | ${\color{green}\text{Project}}$ **Einde sprint 1**, Show & tell (**HS & TM**) <br> Verantwoordingsdocument check (**TM**) in HL15-5.068 |
...
| Dag | Project & Kennissessie |
| --- |  --- |
| ma  | **Start sprint 2** <br>  ${\color{green}\text{Project}}$ Intro [onderzoek opdracht](./lesprogramma/programma-persoonlijke-onderzoeksopdracht.md) (**TM**) |
